...
-- Creating ANZ bank demo database
create database anz;


-- Creating table for user account details
CREATE TABLE anz.user_accounts (
...
CREATE TABLE anz.user_account_transactions (
...
Insert into anz.user_account_transactions(
	account_number,
	account_type,
	transaction_date,
	currency,
...
select * from anz.user_accounts;
select * from anz.user_account_transactions;


-- Finally clearing all the tables and schema

drop table anz.user_accounts;
drop table anz.user_account_transactions;
